...
{
    public class model_Amortización
    {
        private int i;
        ...
        public model_Amortización(int i, double Pcuota, double Ppagointeres, double PpagoCapital, double Psaldo, DateTime PfechaPago)
        {
            this.i = i;
            cuota = Pcuota;
